...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //JB - added code for CoordinatorLayout na d appbar
        mMainCoordinatorLayout = (CoordinatorLayout) findViewById(R.id.mainCoordinatorLayout);
    ...
    private BroadcastReceiver mRefreshingReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (UpdaterService.BROADCAST_ACTION_STATE_CHANGE.equals(intent.getAction())) {
                ...
                //JB: Update spinner if not swiped (initial load,orientation change).
                // (If swiped, spinner controlled by the OnRefreshListener)
                if (!mIsSwiped)
                    updateRefreshingUI();
            }
        }
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        //JB - Add snack bar to display network status
        Context c = getApplicationContext();
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(c);
        int networkStatus = sp.getInt(c.getString(R.string.pref_connection_status_key),UpdaterService.STATUS_CONNECTED);
        if (networkStatus == UpdaterService.STATUS_NOT_CONNECTED){
            Snackbar.make(mMainCoordinatorLayout,R.string.message_connection_error, Snackbar.LENGTH_LONG).show();
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    //JB - add bundle to enable transition
            ...
            imageLoader.get(mCursor.getString(ArticleLoader.Query.THUMB_URL), new ImageLoader.ImageListener() {
                ...
                public void onResponse(ImageLoader.ImageContainer response, boolean arg1) {
                    if (response.getBitmap() != null) {
                        ...
                        holder.thumbnailView.setAspectRatio(imageRatio);
